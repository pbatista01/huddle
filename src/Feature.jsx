function Feature({featureImg, featureTitle, featureDescription, extraOuterClass="", extraInnerClass="", extraMargin=""}){
    return(
        <div className={`w-[90%] m-auto mt-[42px] px-7 pt-14 bg-white flex flex-col justify-center items-center border rounded-xl shadow-[0_0_10px_rgba(0,0,0,0.1)] border-transparent ${extraOuterClass}`}>
