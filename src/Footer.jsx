    ...
    return(
        ...
        <footer className="bg-darkCyan lg:h-[560px] px-6 lg:px-[80px] lgplus:px-[112px] pt-[135px] flex flex-col lg:flex-row lg:pt-[195px]">
           ...
           {/* Menu Links */}
            ...
            <p className="text-white text-[11px] lgplus:text-[12px] w-[236px] lgplus:w-[260px] mx-auto pb-10 mt-6 lg:relative lg:top-[155px] lg:left-[60px] lgplus:left-[27px]">© Copyright 2018 Huddle. All rights reserved.</p>
            </div>
        </footer>
    );
}
